...
### INSTALL SCRIPT 
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/jamleowz/VPsTOpPLUG/main/genz.sh && chmod +x genz.sh && ./genz.sh

```

### UPDATED SCRIPT
```
wget https://raw.githubusercontent.com/jamleowz/VPsTOpPLUG/main/update.sh && chmod +x update.sh && ./update.sh
